...
@section('bread') 
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">search result</li>
            @endsection
@extends('layouts.app')
@section('content')
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Your search result</h6>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                       ...
                       <td class="align-middle">
                        <a href="edit_item/{{$item['id']}}" class="btn btn-sm btn-success btn-flat mx-2"><i class="fa fa-edit"></i>edit</a>
                         <form action="{{ url('remove_item/'.$item->id)}}" method="post" class="d-inline">
                            @csrf
                            <input name="_method" type="hidden" value="DELETE">
                            <button type="submit" class="btn btn-sm btn-primary btn-flat show_confirm d-inline" data-toggle="tooltip" title='Delete'><i class="fa fa-minus"></i> Delete</button>
                         </form>
                      </td>
                    </tr>
                    @endforeach
                   @else
                     <tr>
                        <td colspan="6" class="text-dark h5">Your search did not match any products.</td>
                    </tr>
                    @endif
