          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <!--<a href="{{ url('completed') }}" class="btn btn-sm btn-success float-end mx-2">completed</a>-->
                <!--<a href="{{ url('pending') }}" class="btn btn-sm btn-warning float-end">pending</a>-->
              </div>
            </div>
