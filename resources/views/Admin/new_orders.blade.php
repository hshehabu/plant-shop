@section('bread') 
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pending</li>
            @endsection
@extends('layouts.app')
@section('content')
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">New orders</h6>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                       ...
                       <a href="{{ url('view/'.$item->id.'/order') }}" class="btn btn-primary">view</a>
                      </td>
                    </tr>
                    @endforeach
                   @else
                     <tr>
                        <td colspan="6" class="text-dark h5">no pending order</td>
                    </tr>
                    @endif
