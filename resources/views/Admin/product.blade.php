                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0">{{$item['selling_price']}} ETB</p>
                          </div>
                        </div>
                      </td>
                      <td>
                     ...
                     <td>
                                    <a href="edit_item/{{$item['id']}}" class="btn btn-sm btn-secondary btn-flat mx-2"><i class="fa fa-edit"></i> edit</a>
